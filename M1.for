...
C
C
C     THIS IS THE DRIVER FOR THE SHAW MODEL (VERSION 3.0.2)
C
...
C
     ...
     >     VLCDT(99),VICDT(99),SALTDT(10,99),AV1(100),AV2(100)
      REAL DGRADE(10),SLTDIF(10),ASALT(99),DISPER(99),SOLUBILITY
C
      INTEGER YRSTAR,HRSTAR,YREND,HOUR,YEAR
      INTEGER LEVEL(6),LVLOUT(20)
      INTEGER ITYPE(8),ICESDT(99),ICESPT(100)
C
...
C
     ...
     >  ALATUD,SLOPE,ASPECT,HRNOON,AV1,AV2,SOLUBILITY)
C
      JULIAN=JSTART
      HOUR=HRSTAR
      YEAR=YRSTAR
...
C
     ...
     >   IFLAGSI,INITAL,ITMPBC,IVLCBC,LVLOUT(2),MPLTGRO,NRCHANG,
...
C
     ...
     >    IFLAGSI,1,ITMPBC,IVLCBC,LVLOUT(2),MPLTGRO,NRCHANG,MWATRXT,NS,
...
C 
     ...
     >  SOILXT(1,HOUR),AV1,AV2,SOLUBILITY)
C
      INITAL=1
C
      GO TO 100
...
C***********************************************************************
     ...
     >                ROCK(99),SAND(99),SILT(99),CLAY(99),OM(99),IWRC
      COMMON /MATRIX/ A1(250),B1(250),C1(250),D1(250),
     >                A2(250),B2(250),C2(250),D2(250)
cxOUT
      COMMON /WINDV/ ZH,ZM,ZERO,USTAR,STABLE,CONRH,CONRV,ZHLOG,
     >               ZMSUB,ZHSUB,ZERSUB,WINDC(11),WINDR(10)
cxOUT
      REAL LF,LV,LS,MELT,RS,RSC,SF,SOLUBILITY,SOLUB_CONC
C
      REAL SOILXT(99),AV1(100),AV2(100),SOLUB_CONC1
C
...
C
     ...
     >     QVSP(100),TQVSP(100),WLAG(11)
      ...
      REAL DELTA(250),DELNRG(250),DELWTR(250)
C
      INTEGER HOUR,HRSTRT,YEAR
      INTEGER LEVEL(6),LVLOUT(20)
      INTEGER ITYPE(8),HTORDR(8)
      INTEGER IBICES(99),ICES(99),ICESDT(99),ICESP(100),ICESPT(100)
C
...
!      SOLUBILITY = 350.00
      ...
      DO 210 J=1,NSALT
         ...
         SOLUB_CONC=SOLUB_CONC+(CONC(J,1)*WT+CONCDT(J,1)*WDT)
  ...
  210 CONTINUE
      ...
      RS=3.5*(SOILWRC(1,2)/(WT*VLC(1)+WDT*VLCDT(1)))**2.3+33.5
      IF(NSALT .GE.1) THEN
          SOLUB_CONC1 = SOLUB_CONC*58.5 - SOLUBILITY
          IF(SOLUB_CONC1 .GT. 0) THEN 
              SF=SOLUB_CONC1*1.25+EXP(-AV1(1)/AV2(1))
              RSC=(AV2(1)*LOG(SF)+ AV1(1))*100
!             WRITE(*,*) RSC,RS
          ELSE
              RSC=0
              SF=0
...
!      IF(NSALT .GE.1) THEN
!          SOLUB_CONC1 = SOLUB_CONC*58.5 - SOLUBILITY
!          IF(SOLUB_CONC1*1.25 .GT. EXP(-AV1(1)/AV2(1))) THEN 
!              SF=SOLUB_CONC1*1.25+EXP(-AV1(1)/AV2(1))
!              RSC=(AV2(1)*LOG(SF)+ AV1(1))*100
!              WRITE(*,*) RSC,RS
!          ELSE
...
!          IF(SOLUB_CONC*58.5 .GT. SOLUBILITY) THEN
!              SOLUB_CONC1 = SOLUB_CONC*58.5 - SOLUBILITY
!              SF=SOLUB_CONC1*1.25+EXP(-AV1(1)/AV2(1))
!              RSC=(AV2(1)*LOG(SF)+ AV1(1))*100
!          ELSE
...
!          ENDIF
!          ENDIF
!      SF=SALT(1,1)*58.5*RHOB(1)/1000*1.25
      
!      IF(SF .GT. EXP(-AV1(1)/AV2(1))) THEN
!          RSC=(AV2(1)*LOG(SF)+ AV1(1))*100
!          WRITE(*,*) RSC,RS
!      ELSE
!          RSC=0
...
C     OPEN PROFILES FILE
      IF (IOUTPUT .EQ. 2) THEN 
C        IF VERSION 2.X, READ THIS FILE AT THIS POINT
         READ (10,100) OFILE
...
C     
C     OPEN PROFILES FILE
      IF (IOUTPUT .NE. 2) THEN 
C       IF VERSION 2.X, THIS FILE HAS ALREADY BEEN READ AND OPENED
        READ (10,100) OFILE
        IF (LVLOUT(2) .GT. 0) THEN 
...
C***********************************************************************
     ...
     >                NSALT,SALTKQ(10,99),VAPCOF(99),VAPEXP(99),
     >                ROCK(99),SAND(99),SILT(99),CLAY(99),OM(99),IWRC
      COMMON /MEASUR/ MEASDY,MEASHR,VLCMES(99),TSMEAS(99)
      REAL LF,LS,LV,AV1(100),AV2(100),SOLUBILITY
C
      REAL DCHAR(8),CANALB(8),PINTRCP(8),XANGLE(8),CLUMPNG(8),TCCRIT(8),
...
C
     ...
     >     SALTDT(10,99)
      ...
      INTEGER ICESDT(99),ICESPT(100),LEVEL(6)
...
C**** INPUT PROPERTIES AND INITIAL CONDITIONS FOR EACH TYPE OF SOLUTE
      ...
      DO 30 I=1,NSALT
         READ (11,*) SLTDIF(I),HAFLIF,SOLUBILITY
...
C
     ...
     >       SOILWRC(I,2),SAND(I),SILT(I),CLAY(I),OM(I),AV1(I),AV2(I)
            ELSE            
             READ (11,*) ZS(I),SOILWRC(I,3),SOILWRC(I,1),SATCON,RHOB(I),
     >       SOILWRC(I,2),SAND(I),SILT(I),CLAY(I),OM(I),AV1(I),AV2(I),
     >       ASALT(I),DISPER(I)
     ...
     >       AV1(I),AV2(I),RHOB(I),SATCON,SATKL,(SOILWRC(I,J),J=1,NWRC)
            ELSE
             READ (11,*) ZS(I),SAND(I),SILT(I),CLAY(I),ROCK(I),OM(I),
     >       AV1(I),AV2(I),RHOB(I),SATCON,SATKL,(SOILWRC(I,J),J=1,NWRC),
     >       ASALT(I),DISPER(I)
...
C
     ...
     >   IVERSION,IFLAGSI,INITAL,ITMPBC,IVLCBC,LVLOUT2,MPLTGRO,NRCHANG,
     >   MWATRXT,NS,ALATUD,HRNOON,SUNHOR,TMPDAY,WINDAY,HUMDAY,PRECIP,
     >   SNODEN,SOITMP,VLCDAY,SOILXT,NPLANT,PLTHGT,DCHAR,CLUMPNG,PLTWGT,
     >   PLTLAI,ROOTDP,ZRTHIK,RLOAD,COVER,ALBRES,RESCOF,RESTKB)
C
...
C     SKIP BOUNDARY CONDITIONS IF NOT NECESSARY
      IF (IVLCBC .EQ. 0 .OR. LVLOUT2 .GT. 0) THEN
      IF (INITAL .EQ. 0) THEN
         LVLCDY=JULIAN
         LVLCHR=INHOUR
         LVLCYR=YEAR
...
C           ALGORITHM ASSUMES HOUR 24 IS HOUR 0 -- ADJUST DAY AND HOUR
            ...
            END IF
         END IF
         IF (LVLCDY.EQ.JULIAN+1 .AND. LVLCHR.EQ.0) THEN 
C           THIS IS THE END OF CURRENT DAY - SAVE FOR OUTPUT
            MEASHR = LVLCHR
            MEASDY = LVLCDY
            DO 66 I=1,NS
               VLCMES(I) = VLC1(I)
...
C
C     SKIP BOUNDARY CONDITIONS IF NOT NECESSARY
      IF (ITMPBC .EQ. 0 .OR. LVLOUT2 .GT. 0) THEN
      IF (INITAL .EQ. 0) THEN
         LTMPDY=JULIAN
         LTMPHR=INHOUR
         LTMPYR=YEAR
...
C        OUT ALONG WITH THE MOISTURE DATA IN SUBROUTINE 'OUTPUT'
         IF (LTMPDY .EQ. MEASDY  .AND.  LTMPHR .EQ. MEASHR) THEN
C           SAVE TEMPERATURE DATA FOR PROFILE OUTPUT FILE (THIS CATCHES
C            INPUT PROFILE IF NEXT OBSERVATION COMES AFTER CURRENT DAY)
            DO 45 I=1,NS
               TSMEAS(I) = TMP1(I)
   45       CONTINUE
         END IF
...
C           ALGORITHM ASSUMES HOUR 24 IS HOUR 0 -- ADJUST DAY AND HOUR
         ...
         IF (LTMPDY .EQ. MEASDY  .AND.  LTMPHR .EQ. MEASHR) THEN
C           SAVE TEMPERATURE DATA FOR PROFILE OUTPUT FILE (THIS CATCHES
C           INPUT PROFILE IF IT COMES AT END OF CURRENT DAY)
            DO 46 I=1,NS
               TSMEAS(I) = TMP1(I)
   46       CONTINUE
         END IF
...
C**** DETERMINE THE SOIL AND SNOW ALBEDO
      IF(SF .GT. 150) SF = 150
      ALBSOI=ALBDRY*EXP(-ALBEXP*VLC)+0.002*SF
      IF (NSP.GT.0) THEN
         IF (NR .GT. 0) THEN
            ALBNXT=ALBRES
            ALBNXTDIR=ALBRES
...
C***********************************************************************
     ...
     >     WCAN(10),WCANDT(10),PCAN(8),PCANDT(8)
      ...
      INTEGER ICES(99),ICESDT(99),ICESP(100),ICESPT(100)
C
C     SOIL PROPERTIES
      DO 15 I=1,NS
         TS(I)=TSDT(I)
...
C***********************************************************************
     ...
     >                FBDU(8),FDDU(8)
      COMMON /RADRES/ TDIREC(10),TDIFFU(10)
      REAL TC(11),TSP(100),TR(10),TS(99)
      INTEGER ICESPT(100)
C
      N = 1
      MATERL=2
...
C
C***********************************************************************
      REAL UC(10),SC(10),USP(100),SSP(100),UR(10),SR(10),US(99),
     >     SS(99),SINK(10,99),SWCAN(9,10),SWSNOW(100),SWRES(10),SWSOIL,
...
C
     ...
     >     TRNSP(9),XTRACT(99),HEATC(10),ETLYR(10),DETLYR(10),
     >     DHEATC(10),DTLDTC(10)
      INTEGER ITYPE(8)
      SAVE CONT
C
...
C****       DETERMINE THE HUMIDITY FROM THE TOTAL WATER POTENTIAL
   ...
   10       CONTINUE
            ...
            OPEN(1000,FILE='OUT.TXT')
           IF(I .EQ. 1)WRITE(1000,*) 
     >    EXP(.018*G/UGAS/(TS(I)+273.16)*TOTPOT),VLC(I)
...
C***********************************************************************
     ...
     >                A2(250),B2(250),C2(250),D2(250)
      ...
      REAL LF,LS,LV
C
      REAL ZSP(100),QVSP(100),TSPDT(100),TSDT(99)
C
...
C***********************************************************************
     ...
     >                NSALT,SALTKQ(10,99),VAPCOF(99),VAPEXP(99),
     >                ROCK(99),SAND(99),SILT(99),CLAY(99),OM(99),IWRC
      REAL LF,LS,LV,SOLUBILITY,M1(99,99)
C
      REAL DGRADE(10),SLTDIF(10),ASALT(99),DISPER(99)
...
C           ADJUST TOTAL SALTS AND SOLUTE CONCENTRATION FOR DEGRADATION
            ...
            CONCDT(J,I)=SALTDT(J,I)/(SALTKQ(J,I)+VLCDT(I)*RHOL/RHOB(I))
            IF(CONCDT(J,I)*58.5 .GT.SOLUBILITY) THEN
                M1(J,I)= CONCDT(J,I)*58.5 - SOLUBILITY
                M1(J,I)= (SALTKQ(J,I)+VLCDT(I)*RHOL/RHOB(I))* M1(J,I)
            ELSE 
                M1(J,I)=0
            ENDIF
   40    CONTINUE
...
C
     ...
     >     SWCAN(9,10),SWSNOW(100),SWRES(10),SWDOWN(11),SWUP(11)
C
      REAL QVC(10),QVR(10),QVSP(100),QSL(99),QSV(99),TRNSP(9),
     >     XTRACT(99),ROOTXT(99),FLOLAT(99),TOTFLO(99),TOTLAT(99),
     >     TQVSP(100),TRANSP(8)
      REAL LF,LS,LV
C
      SAVE TRANSP
...
C
     ...
     >   TQVSP(100),WLAG(11),ZR(10),TRDT(10),GMCDT(10),RHOR(10),ZS(99),
     >   TSDT(99),VLCDT(99),VICDT(99),MATDT(99),TOTFLO(99),
     >   SALTDT(10,99),CONCDT(10,99)
      REAL MELT
      INTEGER ITYPE(8),ICESPT(100),ICESDT(99)
C
...
C***********************************************************************
     ...
     >                ROCK(99),SAND(99),SILT(99),CLAY(99),OM(99),IWRC
      REAL LF,LS,LV
C
      REAL ZS(99),TSDT(99),VLCDT(99),VICDT(99),MATDT(99),
     >     TOTFLO(99),SALTDT(10,99),CONCDT(10,99),SATKMX(99),MATRIC(99),
     >     CS(99)
      INTEGER ICESDT(99)
      REAL INFMAX,INFIL,PSAT(99),VLC9(99),MAT9(99),SATK9(99)
C
...
C
C
      IF ( (HOUR.EQ.MEASHR .AND.JULIAN.EQ.MEASDY .AND.LVLOUT(2).GT.0) 
     >   .OR. (HOUR.EQ.24 .AND.MEASHR.EQ.0 .AND.JULIAN+1.EQ.MEASDY .AND.
     >    LVLOUT(2).GT.0) ) THEN
